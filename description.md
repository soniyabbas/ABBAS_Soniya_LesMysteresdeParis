...
Voici une analyse de livre _Les mystères de Paris. Tome 1_ d'Eugène Sue. Elle a été effectuée dans le cadre du cursus "Histoire des Humanités". L'idée est de retravailler le texte pour ensuite l'analyser avec des outils différents et voir le résultat statistique à l'aide de visualisations. Tout d'abord, je vous présenterai toutes les étapes techniques et  préparatoires avant de commencer l'analyse. Ensuite, je ferai l'observation (du processus d'analyse des données) et leur visualisation en utilisant des différents moyens. Enfin, nous finirons par une conclusion et une réflexion autour de la question qui a été posée dans le cadre du TD. 
